...
public class DatabaseInitializer {
    ...
    public void populate() throws Exception {
        ...
        List<Product> products = Arrays.asList(
                ...
                new Product("马尔代夫", "PD-00002", "<p>马尔代夫位于斯里兰卡南方的海域里，被称为印度洋上人间最后的乐园。马尔代夫由露出水面及部分露出水面的大大小小千余个珊瑚岛组成。<br>" +
                ...
                new Product("法国，普罗旺斯", "PD-00004", "<p>它已不再是一个单纯的地域名称，更代表了一种简单无忧、轻松慵懒的生活方式，一种宠辱不惊，看庭前花开花落；去留无意，望天上云卷云舒的闲适意境。如果旅行是为了摆脱生活的桎梏，普罗旺斯会让你忘掉一切。</p>", 9999.0),
                new Product("捷克共和国，布拉格", "PD-00005", "<p>布拉格是保存最完整的中世纪城市之一。它一定是任何旅游名单上的必去之地。不要错过夜晚的城堡美景。城堡在灯光的映衬之下显得尤为壮观。</p>", 9999.0)
